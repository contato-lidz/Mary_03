...
st.set_page_config(page_title="Execução Mary 03")
...
with st.container():
        ...
        def send_email(to_email, to_name):
            ...
            msg['To'] = to_email
            msg['Subject'] = "Impacto Financeiro"
            ...
            <html>
                <body>
                    ...
                    <p>Em 2024, houve o maior vazamento de dados da história, com 26 bilhões de informações dos usuários vazadas, incluindo pessoas do Brasil, Alemanha e EUA.</p>
                    <p>Riachuelo, Habib’s, Petrobras e outras grandes empresas do Brasil foram impactadas!</p>
                    <p>Em um mundo em constante digitalização, a segurança da informação é crucial para proteger informações sensíveis e assegurar a continuidade das operações comerciais. Com a evolução constante das ameaças cibernéticas, as organizações precisam estar preparadas para lidar com possíveis vulnerabilidades de segurança. </p>
                    <p>Podemos conversar para compreender de que forma podemos ajudar na segurança da informação da sua empresa?</p>
                    <p>Muito obrigada!</p>
                </body>
            </html>
            """
